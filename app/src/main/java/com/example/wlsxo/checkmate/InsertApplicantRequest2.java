...
public class InsertApplicantRequest2  extends StringRequest {
    final static private String URL =
            "http://wodud2083.cafe24.com/Checkmate/insertapplicant2.php";//php이름 지정
    private Map<String, String> parameters;

    public InsertApplicantRequest2(int roomNumber, int t_num, String memberID1, String memberID2, Response.Listener<String> listener) {
