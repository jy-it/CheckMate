...
public class CreateRoomRequest3  extends StringRequest {
    final static private String URL =
            "http://wodud2083.cafe24.com/Checkmate/create_room3.php";//php이름 지정
    private Map<String, String> parameters;

    public CreateRoomRequest3(String roomTitle, String roomComment, int joinNum, String [] memberID, Response.Listener<String> listener) {
